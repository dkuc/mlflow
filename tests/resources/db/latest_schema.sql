...
CREATE TABLE mcp_access_bindings (
	...
	CONSTRAINT mcp_access_bindings_server_fkey FOREIGN KEY(workspace, server_name) REFERENCES mcp_servers (workspace, name) ON DELETE CASCADE
)
...
CREATE TABLE mcp_server_tags (
	...
	CONSTRAINT mcp_server_tags_server_fkey FOREIGN KEY(workspace, name) REFERENCES mcp_servers (workspace, name) ON DELETE CASCADE
)
...
CREATE TABLE mcp_server_versions (
	...
	CONSTRAINT mcp_server_versions_server_fkey FOREIGN KEY(workspace, name) REFERENCES mcp_servers (workspace, name) ON DELETE CASCADE
)
...
CREATE TABLE mcp_server_version_tags (
	...
	CONSTRAINT mcp_server_version_tags_version_fkey FOREIGN KEY(workspace, name, version) REFERENCES mcp_server_versions (workspace, name, version) ON DELETE CASCADE
)
