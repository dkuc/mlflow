...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("server_json", sa.JSON(), nullable=False),
        sa.Column("display_name", sa.String(length=256), nullable=True),
        sa.Column(
            "status",
            sa.String(length=20),
        ...
        sa.PrimaryKeyConstraint(
            "workspace", "name", "version", name="mcp_server_versions_pk"
        ),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "workspace", "name", "alias", name="mcp_server_aliases_pk"
        ),
    )
    ...
    op.create_table(
        "mcp_access_bindings",
        sa.Column(
            "binding_id", sa.Integer(), autoincrement=True, nullable=False
        ),
        sa.Column(
            "workspace",
            sa.String(length=63),
        ...
        sa.Column("server_version", sa.String(length=256), nullable=True),
...
def downgrade():
    ...
    op.drop_index(
        "ix_mcp_access_bindings_server_name", table_name="mcp_access_bindings"
    )
